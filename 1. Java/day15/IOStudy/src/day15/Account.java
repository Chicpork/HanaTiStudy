...
public class Account implements Serializable {
	...
	private int passwd;
	transient private long restMoney;
	...
	public Account(String accountNum, String accountOwner, int passwd, long restMoney) throws AccountException {
		this.accountNum = accountNum;
		this.accountOwner = accountOwner;
		if(passwd < 0) {
			throw new AccountException("비밀번호는 0보다 큰 정수형이어야 합니다.",-9);
		}
		this.passwd = passwd;
